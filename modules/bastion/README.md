...
| <a name="input_worker_instance_types"></a> [worker\_instance\_types](#input\_worker\_instance\_types) | Bastion instance types used for spot instances. | `list(string)` | <pre>[<br>  "t3a.large",<br>  "t3.large"<br>]</pre> | no |
